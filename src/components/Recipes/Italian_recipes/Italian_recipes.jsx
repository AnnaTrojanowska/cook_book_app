...
const Italian_recipes = () => {  
  ...
  useEffect(() => {
    ...
    fetch(`https://api.spoonacular.com/recipes/complexSearch?apiKey=${apiKey}&number=9&cuisine=Italian`)
      .then(response => {
        if (!response.ok) {
  ...
  return ( <>
    <h3 className='heading_recipe'>KUCHNIA WŁOSKA</h3>
    <div>
...
export default Italian_recipes